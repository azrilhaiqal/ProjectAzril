        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2" style="background-image: url('img/banner/alihsan-picsay.jpg');">
             ...
             <div class="slider_text ">
                                <center><h3 style="color:white"> Pengaduan Masyarakat<br>
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa Batujajar Barat Kec. Batujajar<br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan Desa Batujajar</p></center>
                                <div class="video_service_btn">
                                    <center><a href="#" class="boxed-btn3" style="text-transform: uppercase; font-size:15px"><i class="fa fa-user"> <?php echo $_SESSION['nama']?></i></a>
